const items = {
  ...
  recommended: `SELECT restaurants.name, items.name AS item, items.id AS itemID, categories.name AS category, categories.id AS category_id, users.username AS created_by, items.price, items.description, items.total_ratings, items.images, items.date_created, items.date_updated 
